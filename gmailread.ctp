    ...
    <?php
		...
		<div class="contentpanel">      
			...
			<div class="paging-container">
						<p></p>
						<a style="float: left;" href="<?php echo $this->Url->build(['controller' => 'Messages', 'action' => 'logout']);?>" title="Send Mail" class="btn btn-primary mr5 ml10" >Gnail Logout</a>
						<p></p>
      <ul>
      ...
      <div class="cl"></div>
			</div><!-- paging-container Pafination -->
